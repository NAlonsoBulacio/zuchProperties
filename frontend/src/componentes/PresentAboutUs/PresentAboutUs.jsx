      ...
      <div className="w-1/2">
        <div className="max-w-[700px] space-y-2">
          ...
          <p className="text-lg text-center text-gray-600">
            Somos una agencia especializada en conexiones online para el sector
            inmobiliario. Nos destacamos como tu enlace estratégico, facilitando
            conexiones valiosas en el entorno digital, trabajando tanto con
            brokers profesionales como con particulares.
          </p>
          <h1 className="font-raleway-700 text-center text-xl md:text-2xl pt-6">
            Nuestro enfoque:
          </h1>
          <p className="text-lg text-gray-600">
            En Zuch Properties, simplificamos la conexión entre compradores y
            vendedores, ofreciendo una plataforma digital que potencia la
            colaboración y el crecimiento, ya sea que seas un broker con
            experiencia o un particular buscando la casa de tus sueños.
          </p>
          <p className="text-lg text-gray-600">
            Únete a Zuch Properties y experimenta una nueva dimensión de
            conexiones online en el mundo inmobiliario.
          </p>
          <p className="text-lg text-gray-600">
            Atentamente,
            <br />
